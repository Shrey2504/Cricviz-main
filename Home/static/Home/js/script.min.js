window.innerWidth < 768 &&
  ...
  (function (e, t) {
        ...
        function (e, t) {
          w.fn[e] = function (n, i) {
            ...
            return (
              ...
              1 < this.length &&
                (j[e] || w.uniqueSort(r), L.test(e) && r.reverse()),
              this.pushStack(r)
            );
          };
        }
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            var t = this || e;
            return (
              de.test(t.type) && t.click && A(t, "input") && Ne(t, "click", xe),
              !1
            );
          },
          trigger: function (e) {
    ...
    function Re(e, t, n, i) {
      ...
      var r,
        ...
        m = t[0],
        v = g(m);
      if (v || (1 < d && "string" == typeof m && !p.checkClone && Oe.test(m)))
      ...
      if (
        ...
        for (l = (a = w.map(me(r, "script"), He)).length; f < d; f++)
          (u = r),
            f !== h &&
        ...
        if (l)
          for (
            c = a[a.length - 1].ownerDocument, w.map(a, Pe), f = 0;
            f < l;
            f++
          )
            (u = a[f]),
    ...
    w.extend(w.event, {
      trigger: function (t, n, r, o) {
        ...
        if (
          ...
          if (!o && !h.noBubble && !m(r)) {
            for (
              u = h.delegateType || y, Et.test(u + y) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              v.push(a), (l = a);
          ...
          for (s = 0; (a = v[s++]) && !t.isPropagationStopped(); )
            (p = a),
              (t.type = 1 < s ? u : h.bindType || y),
              (d = (X.get(a, "events") || {})[t.type] && X.get(a, "handle")) &&
                d.apply(a, n),
              (d = c && a[c]) &&
                d.apply &&
                V(a) &&
        ...
        ajax: function (t, n) {
          ...
          function x(t, n, i, a) {
            ...
            c ||
              ...
              (_ = void 0),
              f &&
                m.trigger(u ? "ajaxSuccess" : "ajaxError", [C, p, u ? d : h]),
              y.fireWith(g, [C, T]),
              f &&
    ...
    w.ajaxSetup({
      ...
      (p.createHTMLDocument =
        (((zt = i.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
    ...
    return (
      (w.noConflict = function (t) {
        return (
          e.$ === w && (e.$ = Gt), t && e.jQuery === w && (e.jQuery = Xt), w
        );
      }),
      t || (e.jQuery = e.$ = w),
      w
  ...
  (function (e, t) {
    ...
    function g(e, n) {
      ...
      o && a && ((c.top = Q(c.top, 0)), (c.left = Q(c.left, 0)));
      var v = h({
        top: l.top - c.top - g,
    ...
    function w(e, t, n, i, r) {
      ...
      var s = _(n, i, o, r),
        ...
        l = Object.keys(a)
          .map(function (e) {
            return ne({ key: e }, a[e], { area: b(a[e]) });
          })
          .sort(function (e, t) {
    ...
    for (
      ...
      if ($ && 0 <= navigator.userAgent.indexOf(z[Y])) {
        V = 1;
        break;
      }
    var X =
      ...
      J = $ && /MSIE 10/.test(navigator.userAgent),
      Z = function (e, t) {
        if (!(e instanceof t))
      ...
      ie = $ && /Firefox/i.test(navigator.userAgent),
      re = [
        "auto-start",
        "auto",
        "auto-end",
      ...
      ue = (function () {
        function t(n, i) {
          ...
          Z(this, t),
            ...
            Object.keys(ne({}, t.Defaults.modifiers, o.modifiers)).forEach(
              function (e) {
                r.options.modifiers[e] = ne(
                  {},
            ...
            fn: function (e) {
              ...
              if (i) {
                var r = e.offsets,
                  ...
                  c = {
                    start: te({}, l, o[l]),
                    end: te({}, l, o[l] + o[u] - s[u]),
                  };
                e.offsets.popper = ne({}, s, c[i]);
              }
              return e;
            },
          },
          ...
          arrow: {
            ...
            fn: function (e, n) {
              ...
              return (
                (w = Q(B(a[c] - m, w), 0)),
                (e.arrowElement = r),
                (e.offsets.arrow = (te((i = {}), d, K(w)), te(i, p, ""), i)),
                e
              );
            },
            element: "[x-arrow]",
  ...
  (function (e, t) {
      ...
      G = (function () {
        ...
        return (
          ...
          (n.show = function () {
            ...
            if (
              ...
              if ((t(this._element).trigger(o), !o.isDefaultPrevented())) {
                ...
                t(this._element).removeClass($).addClass(z),
                ...
                t(this._element)
                  .one(a.TRANSITION_END, function () {
                    t(r._element).removeClass(z).addClass($).addClass(Q),
                      (r._element.style[s] = ""),
            ...
            if (!this._isTransitioning && t(this._element).hasClass(Q)) {
              ...
              if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                ...
                (this._element.style[i] =
                  ...
                  t(this._element).addClass(z).removeClass($).removeClass(Q);
                  ...
                  for (var o = 0; o < r; o++) {
                    ...
                    null !== l &&
                      (t([].slice.call(document.querySelectorAll(l))).hasClass(
                        ...
                        t(s).addClass(V).attr("aria-expanded", !1));
                  }
          ...
          (n._getDimension = function () {
            return t(this._element).hasClass(Y) ? Y : "height";
          }),
    ...
    t(document).on(K.CLICK_DATA_API, X, function (e) {
      ...
      (t.fn[R].noConflict = function () {
        return (t.fn[R] = W), G._jQueryInterface;
      });
    var J = "dropdown",
      Z = "bs.dropdown",
      ee = "." + Z,
            ...
            if (
              ...
              t(r).trigger(i),
                i.isDefaultPrevented() ||
                  (t(this._menu).toggleClass(se),
                  t(r).toggleClass(se).trigger(t.Event(re.SHOWN, n)));
            }
          }),
          (i.hide = function () {
            if (
              ...
              t(r).trigger(i),
                i.isDefaultPrevented() ||
                  (t(this._menu).toggleClass(se),
                  t(r).toggleClass(se).trigger(t.Event(re.HIDDEN, n)));
            }
          }),
          (i.dispose = function () {
    ...
    t(document)
      .on(re.KEYDOWN_DATA_API, le, de._dataApiKeydownHandler)
      .on(re.KEYDOWN_DATA_API, ue, de._dataApiKeydownHandler)
        ...
        return (
          ...
          (e._jQueryInterface = function (n, i) {
            return this.each(function () {
              ...
              if (
                (r || ((r = new e(this, s)), t(this).data(pe, r)),
                "string" == typeof n)
              ) {
                if (void 0 === r[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    t(document).on(_e.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
      ...
      xe._jQueryInterface.call(t(n), s, this);
    }),
      (t.fn[he] = xe._jQueryInterface),
      (t.fn[he].Constructor = xe),
      (t.fn[he].noConflict = function () {
        return (t.fn[he] = me), xe._jQueryInterface;
      });
    var Se = [
        "background",
        "cite",
            ...
            a.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === Se.indexOf(n) ||
                    Boolean(e.nodeValue.match(De) || e.nodeValue.match(Ae))
                  );
                for (
        ...
        return (
            ...
            "object" != typeof n || (!n.nodeType && !n.jquery)
              ? this.config.html
                ? (this.config.sanitize &&
                    (n = Ne(n, this.config.whiteList, this.config.sanitizeFn)),
                  e.html(n))
                : e.text(n)
              : this.config.html
          ...
          (i._enter = function (e, n) {
            ...
            (n = n || t(e.currentTarget).data(i)) ||
              ...
              e && (n._activeTrigger["focusin" === e.type ? $e : Qe] = !0),
              t(n.getTipElement()).hasClass(Ke) || n._hoverState === Fe
                ? (n._hoverState = Fe)
          ...
          (i._leave = function (e, n) {
            ...
            (n = n || t(e.currentTarget).data(i)) ||
              ...
              t(e.currentTarget).data(i, n)),
              e && (n._activeTrigger["focusout" === e.type ? $e : Qe] = !1),
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (i || ((i = new e(this, r)), t(this).data(ke, i)),
                "string" == typeof n)
              ) {
                if (void 0 === i[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (t.fn[Ie] = ze._jQueryInterface),
      (t.fn[Ie].Constructor = ze),
      (t.fn[Ie].noConflict = function () {
        return (t.fn[Ie] = Le), ze._jQueryInterface;
      });
    var Ve = "popover",
      Ye = "bs.popover",
      Xe = "." + Ye,
      ...
      tt = o({}, ze.DefaultType, { content: "(string|element|function)" }),
      nt = {
        HIDE: "hide" + Xe,
        HIDDEN: "hidden" + Xe,
        SHOW: "show" + Xe,
          ...
          (o._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (n || ((n = new o(this, i)), t(this).data(Ye, n)),
                "string" == typeof e)
              ) {
                if (void 0 === n[e])
        ...
        return (
          ...
          (n._getConfig = function (e) {
            if (
              ...
              n || ((n = a.getUID(rt)), t(e.target).attr("id", n)),
                (e.target = "#" + n);
            }
            ...
            i.hasClass("dropdown-item")
              ...
              : (i.addClass(ft),
                i
                  ...
                  .prev(ht + ", " + pt)
                  .addClass(ft),
                i.parents(dt).prev(".nav-item").children(ht).addClass(ft)),
    ...
    t(window).on(ct.LOAD_DATA_API, function () {
      ...
      (t.fn[rt] = mt._jQueryInterface),
      (t.fn[rt].Constructor = mt),
      (t.fn[rt].noConflict = function () {
        return (t.fn[rt] = at), mt._jQueryInterface;
      });
    var vt = "bs.tab",
      yt = "." + vt,
      _t = t.fn.tab,
        ...
        return (
          (n.show = function () {
            ...
            if (
              ...
              if (r) {
                var s = "UL" === r.nodeName || "OL" === r.nodeName ? xt : Ct;
          ...
          (n._transitionComplete = function (e, n, i) {
            ...
            if (
              ...
              a.reflow(e),
              e.classList.contains(Et) && e.classList.add(Tt),
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              var i = t(this),
                r = i.data(vt);
              if (
                (r || ((r = new e(this)), i.data(vt, r)), "string" == typeof n)
              ) {
                if (void 0 === r[n])
                  throw new TypeError('No method named "' + n + '"');
                r[n]();
      ...
      qt = (function () {
        ...
        return (
          ...
          (n._close = function () {
            var e = this,
              n = function () {
                e._element.classList.add(Ot), t(e._element).trigger(kt.HIDDEN);
              };
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (r ||
                  ((r = new e(this, "object" == typeof n && n)), i.data(At, r)),
                "string" == typeof n)
              ) {
                if (void 0 === r[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (t.fn[Dt] = qt._jQueryInterface),
      (t.fn[Dt].Constructor = qt),
      (t.fn[Dt].noConflict = function () {
        return (t.fn[Dt] = It), qt._jQueryInterface;
      }),
      (function () {
        if (void 0 === t)
          throw new TypeError(
